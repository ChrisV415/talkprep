    ...
    scenarios: [
      {
        ...
        icon: "alert-circle",
        hint: "Serious diagnosis or prognosis",
      },
      {
        label: "End-of-life care conversation",
        icon: "heart",
        hint: "Goals of care & comfort",
      },
      {
        label: "Addiction intervention",
        icon: "user",
        hint: "Substance use conversation",
      },
      {
        label: "Mental health crisis",
        icon: "shield",
        hint: "Patient in acute distress",
      },
      {
        label: "Informed consent",
        icon: "file-text",
        hint: "Procedure or treatment decision",
      },
      {
        label: "Difficult patient or family",
        icon: "users",
        hint: "Managing conflict & anger",
      },
      {
        label: "Reporting a colleague error",
        icon: "alert-triangle",
        hint: "Patient safety disclosure",
      },
      {
        label: "Clinical team conflict",
        icon: "message-circle",
        hint: "Interprofessional tension",
      },
    ],
  },
  {
    ...
    scenarios: [
      {
        label: "Client deposition prep",
        icon: "file-text",
        hint: "Preparing client to testify",
      },
      {
        label: "Settlement negotiation",
        icon: "trending-up",
        hint: "Reaching a deal",
      },
      {
        label: "Delivering bad case news",
        icon: "alert-circle",
        hint: "Weak position or loss",
      },
      {
        label: "Workplace investigation interview",
        icon: "search",
        hint: "Sensitive fact-finding",
      },
      {
        label: "Client expectation reset",
        icon: "refresh-cw",
        hint: "Scope or timeline change",
      },
      {
        label: "Mediation session",
        icon: "users",
        hint: "Neutral dispute resolution",
      },
      {
        label: "Confidentiality concern",
        icon: "lock",
        hint: "Privilege or disclosure issues",
      },
    ],
  },
  {
    ...
    scenarios: [
      {
        ...
        icon: "trending-down",
        hint: "Placing an employee on a PIP",
      },
      {
        label: "Termination conversation",
        icon: "user-x",
        hint: "Ending employment",
      },
      {
        label: "Hard performance review",
        icon: "clipboard",
        hint: "Honest feedback session",
      },
      {
        label: "Denying a raise or promotion",
        icon: "x-circle",
        hint: "Saying no with care",
      },
      {
        label: "Team conflict resolution",
        icon: "shuffle",
        hint: "Between two employees",
      },
      {
        label: "Layoff notification",
        icon: "alert-triangle",
        hint: "Workforce reduction",
      },
      {
        label: "Promotion conversation",
        icon: "award",
        hint: "Delivering good news well",
      },
      {
        label: "Harassment complaint handling",
        icon: "shield",
        hint: "Sensitive HR investigation",
      },
    ],
  },
  {
    ...
    scenarios: [
      {
        ...
        icon: "dollar-sign",
        hint: "Defending your value",
      },
      {
        label: "Procurement pushback",
        icon: "alert-circle",
        hint: "Contract under pressure",
      },
      {
        label: "Renewal at risk",
        icon: "refresh-cw",
        hint: "Saving a churning account",
      },
      {
        label: "Stalled deal close",
        icon: "target",
        hint: "Moving a stuck opportunity",
      },
      {
        label: "Executive sponsor conversation",
        icon: "trending-up",
        hint: "C-suite alignment",
      },
      {
        label: "Lost deal debrief",
        icon: "x-circle",
        hint: "Learning from a loss",
      },
      {
        label: "Competitive displacement",
        icon: "zap",
        hint: "Unseating a competitor",
      },
      {
        label: "Asking for a referral",
        icon: "share-2",
        hint: "Warm introduction request",
      },
    ],
  },
];
      ...
      <View style={styles.heroBanner}>
        ...
        <View style={styles.heroBannerText}>
          ...
          <Text style={styles.heroSub}>
            AI-powered prep for difficult conversations — walk in confident, not
            nervous.
          </Text>
        </View>
      </View>
      ...
      <View style={styles.scenarioGrid}>
        ...
        <Pressable
          style={({ pressed }) => [
            styles.scenarioCard,
            styles.customCard,
            { opacity: pressed ? 0.75 : 1, borderColor: accentColor + "55" },
          ]}
          onPress={startFresh}
        >
          <View
          ...
          <View style={styles.cardBody}>
            <Text style={[styles.scenarioTitle, { color: accentColor }]}>
              Custom
            </Text>
            ...
            {recentSessions.map((s, i) => (
              ...
              >
                <View style={styles.sessionLeft}>
                  <Text
                    style={[styles.sessionScenario, { color: colors.rust }]}
                  >
                    {s.scenario.toUpperCase()}
                  </Text>
                  <Text style={styles.sessionWho}>
                    {s.who.split(/[,.]/)[0]?.trim()}
                  </Text>
                </View>
